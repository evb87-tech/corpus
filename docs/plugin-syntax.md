...
**For corpus this means**: the pack discovery protocol in `.claude/rules/14-extension-contract.md` cannot rely on a built-in API. Implementation in cor-7el must glob a known cache path:
