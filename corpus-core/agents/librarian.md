...
Follow `.claude/rules/09-maintenance-check.md`:
...
- Do not rewrite old pages to match new rules — that's `.claude/rules/09-maintenance-check.md`'s explicit non-goal.
