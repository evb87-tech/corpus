...
This is contradictor posture from `corpus-core/rules/05-query-postures.md`. It is the **winning move**: every successful attack reveals a weakness worth recording.
...
- Use **only** wiki content unless the owner explicitly invites outside knowledge. See `corpus-core/rules/07-anti-lissage.md`.
